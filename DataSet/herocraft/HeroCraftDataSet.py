...
#specficWebsite = df[df[0].str.contains("../../Dataset/Train/com.herocraft.game.farmfrenzy.freemium")]
...
#specficWebsite1.to_csv('ModifiedHerocraft.csv')

specficWebsite1 = pd.read_csv('ModifiedHerocraft.csv')
...
with open('./DataSet/herocraft/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/herocraft/herocraftPrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
