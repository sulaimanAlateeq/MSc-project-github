...
specficWebsite1 = df[df[0].str.contains("../../Dataset/Train/com.tripadvisor.tripadvisor")]
specficWebsite1 = specficWebsite1[0].str.split("	", expand=True)



specficWebsite1 = pd.read_csv('./DataSet/tripadvisor/Modifiedtripadvisor.csv')
...
#specficWebsite1.to_csv('./DataSet/tripadvisor/Modifiedtripadvisor.csv')
qasdict = dict()
qasdict['qas'] = qas
qasdict['context'] = aa
...
with open('./DataSet/tripadvisor/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/tripadvisor/tripadvisorPrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
