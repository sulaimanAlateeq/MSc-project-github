...
#specficWebsite = df[df[0].str.contains("../../Dataset/Train/com.starbucks.mobilecard")]
#specficWebsite1 = specficWebsite[0].str.split("	", expand=True)
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 99234]
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 100883]
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 101111]
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 101204]
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 101207]
#specficWebsite1 = specficWebsite1[specficWebsite1.index != 101208]



specficWebsite1 = pd.read_csv('./DataSet/starbucks/Modifiedstarbucks.csv')
...
#specficWebsite1.to_csv('./DataSet/starbucks/Modifiedstarbucks.csv')
qasdict = dict()
qasdict['qas'] = qas
qasdict['context'] = aa
...
with open('./DataSet/starbucks/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/starbucks/starbucksPrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
