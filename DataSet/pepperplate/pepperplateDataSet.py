...
#specficWebsite = df[df[0].str.contains("../../Dataset/Train/com.pepperplate")]
#specificWebsite1 = specficWebsite[0].str.split("	", expand=True)

specificWebsite1 = pd.read_csv('./DataSet/pepperplate/Modifiedpepperplate.csv')
...
#specificWebsite1.to_csv('./DataSet/pepperplate/Modifiedpepperplate.csv')
qasdict = dict()
qasdict['qas'] = qas
qasdict['context'] = aa
...
with open('./DataSet/pepperplate/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/pepperplate/pepperplatePrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
