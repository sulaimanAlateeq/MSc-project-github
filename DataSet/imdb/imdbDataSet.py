...
#specficWebsite = df[df[0].str.contains("../../Dataset/Train/com.imdb.mobile")]
...
specficWebsite1 = pd.read_csv('./DataSet/imdb/Modifiedimdb.csv')
...
#specficWebsite1.to_csv('./DataSet/imdb/Modifiedimdb.csv')
qasdict = dict()
qasdict['qas'] = qas
qasdict['context'] = aa
...
with open('./DataSet/imdb/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/imdb/imdbPrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
