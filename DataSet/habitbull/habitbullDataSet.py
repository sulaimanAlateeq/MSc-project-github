...
#specficWebsite = df[df[0].str.contains("../../Dataset/Train/com.oristats.habitbull")]
#specificWebsite1 = specficWebsite[0].str.split("	", expand=True)

specificWebsite1 = pd.read_csv('./DataSet/habitbull/Modifiedhabitbull.csv')
...
#specficWebsite1.to_csv('./DataSet/habitbull/Modifiedhabitbull.csv')
qasdict = dict()
qasdict['qas'] = qas
qasdict['context'] = aa
...
with open('./DataSet/habitbull/data.json', 'w') as f:
    json.dump(qasdict, f)
...
def find_index(text1):
    with open('./DataSet/habitbull/habitbullPrivacyPage.txt', 'r',encoding="utf8") as f:
        content = f.read()
